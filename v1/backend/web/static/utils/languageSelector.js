...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const translationManager = window.translationManager || (await import(/* webpackIgnore: true */ './translationUtils.js')).translationManager;
...
LanguageSelector._instance = null;
